...
from kannax.plugins.utils.circle import crop_vid
from kannax.utils import media_to_image, runcmd, safe_filename
...
async def spinn(message: Message):
    ...
    path = "kannax/xcache/rotate-disc/"
